...
export const MavenMarketplace = () => {
  ...
  return (
    <div className="space-y-8 pb-12 md:space-y-12 md:pb-20">
      <div className="bg-gradient-to-r from-blue-600 to-orange-500 -mx-4 md:-mx-8 px-4 md:px-8 py-16 md:py-32">
      ...
      <div className="space-y-16 md:space-y-24 max-w-[1800px] mx-auto px-4 sm:px-6 md:px-8">
