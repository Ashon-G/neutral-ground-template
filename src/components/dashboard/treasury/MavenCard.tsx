      ...
      <div className="p-6 md:p-8">
        <div className="flex items-start justify-between gap-4 mb-6">
          <div>
            ...
            {/* Rating */}
            <div className="flex items-center gap-1.5 text-base md:text-lg text-yellow-500 mt-1">
              <StarIcon className="h-5 w-5 md:h-6 md:w-6 fill-current" />
              <span>5.0</span>
          ...
          <Badge
            variant="secondary"
            className="bg-secondary/10 text-secondary hover:bg-secondary/20 text-sm md:text-base whitespace-nowrap px-3 md:px-4 py-1 md:py-1.5"
          >
        ...
        {/* Bio */}
        <p className="text-base md:text-lg text-muted-foreground line-clamp-2 mb-6">
        ...
        <div className="pt-4 md:pt-6 border-t border-gray-100">
          <div className="flex items-center justify-between">
            ...
            <span className="font-medium text-lg md:text-xl">$50/hr</span>
          </div>
        </div>
      </div>
    </Card>
